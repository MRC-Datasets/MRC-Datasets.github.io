...
<div class="section">
 ...
 <tr>
    ...
    <tr>
        ...
        <td>Paragraph</td>
        <td>Crowdsourcing</td>
        <td>Factoid questions</td>
        <td>Early Dataset</td>
        <td><button onclick="window.open('https://trec.nist.gov/data/qamain.html');">Dataset</button></td>
    </tr>
    <tr>
        <td>2015</td>
        <td>WikiQA </td>
        <td>Paragraph</td>
        <td>Crowdsourcing</td>
        <td>Relevant Wikipedia pages</td>
    ...
    <tr>
        ...
        <td>Document </td>
        <td>Automated</td>
        <td>OMDb and Wikipedia about movies</td>
        <td>Early Dataset</td>
    ...
    <tr>
        ...
        <td>Crowdsourcing</td>
        <td>Wikipedia</td>
        <td>Complex reasoning/Large scale</td>
        <td><button onclick="window.open('https://rajpurkar.github.io/SQuAD-explorer/explore/1.1/dev/');">Dataset</button></td>
    </tr>
    <tr>
        <td>2016</td>
        <td>Who-did-What</td>
    ...
    <tr>
        ...
        <td>Paragraph</td>
        <td>Search engine</td>
        <td>Web pages,URL,Text</td>
        <td>Unanswerable Questions/Multiple  documents</td>
    ...
    <tr>
        ...
        <td>Building Datasets using Paragraph Vectors/Textual Entailment</td>
        <td><button onclick="window.open('https://github.com/google/mcafp');">Dataset</button></td>
    </tr>
    <tr>
        <td>2016</td>
        <td>MovieQA</td>
        <td>Paragraph,Pictures,Videos</td>
        <td>Crowdsourcing</td>
        <td>Movie Plot,Video,Subtitle,Scripts,DVS</td>
        <td>Multi-Model</td>
    ...
    <tr>
        ...
        <td>Quiz website</td>
        <td>Web page</td>
        <td>Relatively complex, compositional questions, cross sentence reasoning to find answers.</td>
    ...
    <tr>
        ...
        <td>Expert </td>
        <td>Exam </td>
        <td>Complex reasoning and provide explanations for answers</td>
    ...
    <tr>
        ...
        <td>Various internet sources</td>
        <td>Retrieval Systems</td>
        <td><button onclick="window.open('https://github.com/bdhingra/quasar');">Dataset</button></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Document </td>
        <td>Crowdsourcing</td>
        <td>Full text of movie scripts or Literature</td>
        <td>Multi-Passages+complex reasoning</td>
    ...
    <tr>
        ...
        <td>Paragraph</td>
        <td>Crowdsourcing</td>
        <td>Science exam questions</td>
        <td>Science Question Answering</td>
    ...
    <tr>
        ...
        <td>Paragraph</td>
        <td>Crowdsourcing</td>
        <td>Research paper abstracts from PubMed</td>
        <td>Multi-hop </td>
        <td><button onclick="window.open('http://qangaroo.cs.ucl.ac.uk/index.html');">Dataset</button></td>
    </tr>
    <tr>
        <td>2017</td>
        <td>TQA</td>
        <td>Paragraph with diagrams and images</td>
        <td>Expert </td>
        <td>Middle school science curricula</td>
        <td>Multi-Model</td>
    ...
    <tr>
        ...
        <td>Crowdsourcing</td>
        <td>Wikipedia</td>
        <td>Multi-hop Paragraph/Complex reasoning</td>
    ...
    <tr>
        ...
        <td>Crowdsourcing</td>
        <td>Movie plots </td>
        <td>Paraphrased/Multi-Sentences/Complex reasoning</td>
    ...
    <tr>
        ...
        <td>Expert </td>
        <td>Exam </td>
        <td>Deeper language understanding</td>
    ...
    <tr>
        ...
        <td>ReCoRD</td>
        <td>Paragraph</td>
        <td>Automated+crowdworkers</td>
        <td>CNN/Daily Mail+Internet Archive</td>
        <td>Commonsense Reading Comprehension (CRC)</td>
    ...
    <tr>
        ...
        <td>Domain-specific datasets</td>
    ...
    <tr>
        ...
        <td>Paragraph</td>
        <td>Expert </td>
        <td>Grade-school science questions</td>
        <td>Complex reasoning</td>
    ...
    <tr>
        ...
        <td>Paragraph</td>
        <td>Crowdsourcing</td>
        <td>Elementary  level science facts</td>
        <td>Science Question Answering</td>
    ...
    <tr>
        ...
        <td>Paragraph</td>
        <td>Crowdsourcing</td>
        <td>Science questions  and the corresponding answer candidates</td>
        <td>Science Question Answering</td>
    ...
    <tr>
        ...
        <td>Crowdsourcing</td>
        <td>News, Wikipedia Articles,Fiction,science textbooks and so on</td>
        <td>Multiple Sentences</td>
